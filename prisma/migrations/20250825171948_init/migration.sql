...
CREATE TABLE "public"."Progress" (
    ...
    "userId" INTEGER NOT NULL,
    "courseId" INTEGER NOT NULL,
    "completedLessonIds" INTEGER[] DEFAULT ARRAY[]::INTEGER[],
...
-- AddForeignKey
ALTER TABLE "public"."Comment" ADD CONSTRAINT "Comment_lessonId_fkey" FOREIGN KEY ("lessonId") REFERENCES "public"."Lesson"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
